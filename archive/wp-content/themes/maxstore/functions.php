...
function maxstore_theme_stylesheets() {
	...
	wp_enqueue_style( 'maxstore-stylesheet', get_stylesheet_uri(), array(), '1.3.1', 'all' );
...
function maxstore_theme_js() {
	...
	wp_enqueue_script( 'maxstore-theme-js', get_template_directory_uri() . '/js/customscript.js', array( 'jquery' ), '1.3.1' );
}

...
if ( $tags ) {
	...
	if ( $my_query->have_posts() ) {
		echo '<div class="related-posts row"><div class="related-posts-content col-md-12"><div class="related-posts-title"><h3>' . __( 'Related posts', 'maxstore' ) . '</h3><div class="widget-line"></div></div><ul class="row">';

...
//        console.log(this.items);
		...
		$('.clone',this.container).removeClass('active');
		//this.options.jmaxtrixslide && this.slide(this.options.jmaxtrixslide);
...
//			console.log('Responsiver.init()');
		...
		next: function(){
			...
			this.element.parent().parent().removeClass('mts-wrap-prev').addClass('mts-wrap-next');
...
//console.log(this.sliding);
		...
		prev: function(){
			if (this.sliding) return;
			this.element.parent().parent().removeClass('mts-wrap-next').addClass('mts-wrap-prev');
			...
			if (this.options.circular === true){
				...
				if (num_clone < max){
					for(var i = num_clone; i < max; i++){
						...
						this.items.eq(i).clone().appendTo(this.container).addClass('clone').attr('data-slide',i);
					}
				}
			}
			return this.column;

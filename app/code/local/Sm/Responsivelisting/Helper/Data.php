...
class Sm_Responsivelisting_Helper_Data extends Mage_Core_Helper_Abstract {
	public function __construct(){
		$this->defaults = array(
			/* General setting */
			'isenabled'		=> '1',
			'title' 		=> 'SM Responsive Listing',
			/* Module options */
			'nb_column1' 		=> '6',
			'nb_column2' 		=> '4',
			'nb_column3' 		=> '2',
	...
	{
		$data = $this->defaults;
		$general 					= Mage::getStoreConfig("responsivelisting_cfg/general");
		$module_setting				= Mage::getStoreConfig("responsivelisting_cfg/module_setting");
		$product_selection 			= Mage::getStoreConfig("responsivelisting_cfg/product_selection");
		$product_ordering				    = Mage::getStoreConfig("responsivelisting_cfg/product_ordering");
		$tabs_options				= Mage::getStoreConfig("responsivelisting_cfg/tabs_options");
		$product_display_setting 	= Mage::getStoreConfig("responsivelisting_cfg/product_display_setting");
		$advanced 					= Mage::getStoreConfig("responsivelisting_cfg/advanced");
